...
//视频尺寸和位置
function modifyGLViewPositionAndSize(v_msg){
  if(egret.Capabilities.os&&egret.Capabilities.os==='iOS'){
        console.log("call sendImEventMsg for ios platform.");
        var data =v_msg;
        //根据平台区分
         var  bridge = window.WebViewJavascriptBridge;
            bridge.callHandler('modifyGLViewPositionAndSize',data,function(){
            console.log('call modifyGLViewPositionAndSize'+ JSON.stringify(data));
        });
    }
}