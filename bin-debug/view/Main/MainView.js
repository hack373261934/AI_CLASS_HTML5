...
(function (ui) {
    var MainView = (function (_super) {
        ...
        MainView.prototype.init = function (event) {
            ...
            //-----创建图片对象
            egret.ImageLoader.crossOrigin = 'anonymous';
            RES.getResByUrl(GloableData.quizsData.data.quizs[GloableData.classMax].quizItems[GloableData.classMax].mediaUrl, function (data) {
                console.log(data);
                var image = new eui.Image();
                image.source = data;
                _this.GroupBox.addChild(image);
            }, this, RES.ResourceItem.TYPE_IMAGE);
            // ///创建 ImageLoader 对象
